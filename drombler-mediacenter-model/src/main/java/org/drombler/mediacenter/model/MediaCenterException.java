 ...
 * @author Florian
 */
public class MediaCenterException extends BusinessException {
    private static final long serialVersionUID = 2423918971447441288L;

    private final MediaCenterErrorCode errorCode;

    public MediaCenterException(MediaCenterErrorCode errorCode, String message) {
        super(formatMessage(errorCode, message));
        this.errorCode = errorCode;
    }

    public MediaCenterException(MediaCenterErrorCode errorCode, String message, Throwable cause) {
